...
namespace Repository.RepositoryDto
{
    public class DataPoint
    {
        ...
        {
            return
                $"{nameof(StationId)}: {StationId}, {nameof(SensorType)}: {SensorType}, {nameof(SensorValueNumber)}: {SensorValueNumber}, {nameof(SensorTimestampUtc)}: {SensorTimestampUtc}, {nameof(ReceivedTimestampUtc)}: {ReceivedTimestampUtc}";
        }
